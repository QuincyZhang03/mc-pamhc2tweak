...
public class DrinksData {
    public static final Set<String> DRINKABLES =
            Set.of("pamhc2foodextended:apricotjuiceitem",
    ...
    public static final Set<String> THICKS = Set.of("pamhc2foodextended:cactussoupitem",
